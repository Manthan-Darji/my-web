      ...
      <div className="container">
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            >
              CSE Student | Tech Enthusiast | Learner......
            </motion.p>
            ...
            >
              <button
                type="button"
                onClick={onContact}
                className="rounded-lg border bg-card/60 px-5 py-2.5 text-sm font-medium text-foreground neon-ring transition-transform duration-200 hover:-translate-y-0.5"
              >
                Contact Me
              </button>
              <span className="text-xs text-muted-foreground">
                <span className="text-neon-purple">//</span> smooth scroll enabled
              </span>
            </motion.div>
